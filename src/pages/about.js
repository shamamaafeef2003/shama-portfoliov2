  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Learn more about Syeda Shamama Afeef, a Data Scientist at Gwen AI." />
      </Head>
      <TransitionEffect/>
        ...
        <Layout className='pt-16'>
          ...
          <div className='grid w-full grid-cols-8 gap-16 sm:gap-8'>
            ...
            <div className='col-span-3 relative h-max rounded-2xl border-2 border-solid border-dark bg-light p-8 dark:bg-light xl:col-span-4 md:order-1 md:col-span-8'>
              <Image src={profilePic} alt="Syeda Shamamam Afeef" className='w-full h-auto rounded-2xl' 
              priority
